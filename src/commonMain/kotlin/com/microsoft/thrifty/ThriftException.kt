 ...
 */
class ThriftException(val kind: Kind, message: String?) : RuntimeException(message) {
    /**
     * Identifies kinds of protocol violation.
     */
    enum class Kind private constructor(internal val value: Int) {
        /**
        ...
        companion object {
            ...
            internal fun findByValue(value: Int): Kind {
                for (kind in values()) {
                    if (kind.value == value) {
                        return kind
                    }
